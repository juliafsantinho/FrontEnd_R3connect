...
function Login() {
    ...
    return(
        <Grid container direction='row' justifyContent='center' alignItems='center' alignContent="center" className="container">
            <Grid item alignItems='center' xs={4} justifyContent='center'>
